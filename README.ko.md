...
> **⚠️ 2026-07-31 개발 종료 (archived)**
>
> NEKOWORK는 AI 코딩 도구가 만든 코드 변경을 병합 전에 검사하는 로컬 안전 게이트였습니다.
> 공개 알파까지 배포했지만 외부 사용자를 확보하지 못해 개발을 중단합니다.
>
> - 코드는 **MIT 라이선스**로 그대로 남아 있습니다. 포크·재사용 자유입니다.
> - npm 패키지 `@ps-neko/nekowork@alpha`는 **계속 설치·동작**합니다.
> - 이슈·PR 대응과 유지보수는 하지 않습니다.
