...
const EXAMPLE = path.join(ROOT, 'examples', 'github-actions-hardening');

test('github actions hardening example is self-contained and passes local checks', () => {
  const required = [
    'README.md',
    'package.json',
  ...
  assert.match(result.stdout, /github-actions-hardening checks passed/);
});
