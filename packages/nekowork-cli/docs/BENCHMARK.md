...
> Measured: 2026-06-07 (re-run of `npm run bench:rules`) · Slim package version: `0.2.0-alpha.10`
...
> `@alpha` (`0.2.0-alpha.10`) now ships all **11 rules** measured on this page
