...
NEKOWORK `0.1.0-alpha.12` is the current repository and published alpha (npm `@ps-neko/nekowork@alpha`, published 2026-05-26). Use npm alpha for the shortest published install path, or use a submodule/local checkout for repository-pinned workflows and examples.
