...
NEKOWORK `0.1.0-alpha.11` is the current repository and published alpha (npm `@ps-neko/nekowork@alpha`, published 2026-05-16). Use npm alpha for the shortest first-run path, or use a source checkout, submodule, or local repository integration when you need examples, tests, or repository-pinned workflows.
