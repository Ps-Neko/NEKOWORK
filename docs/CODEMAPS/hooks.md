...
| `scripts/persistent-mode.mjs` | _(none)_ | Stop persistent-mode. If .harness/state/sessions/<id>/active exists, drop wakeup.json for `nekowork wait start` to process. |
