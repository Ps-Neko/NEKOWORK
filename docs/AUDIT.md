...
| 단위 테스트 | **81/81 PASS** (기존 56 + auth guard / core runner utils / git mutation guard / runner wrapper / codex normalization / live fallback guard / token vault 등) |
...
- local-first auth 포팅 + Codex mutation guard 후 테스트 98/98 PASS
